...
angular.module('arseApp')
  .controller('UserManagementCtrl', ['$scope', 'Project', '$stateParams', '$http', '$state', function ($scope, Project, $stateParams, $http, $state) {    

    $scope.project = Project.get({ id: $stateParams.project_id });
    // $scope.sprint;

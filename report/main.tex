...
\begin{wrapfigure}{R}{0.5\textwidth}
  \centering
  	\includegraphics[height=20EM]{img/architecture}
...
\item \textbf{Express.js} is web application framework for Node.js. It's the backend part of the application, handling such things as API endpoints, controllers and wit mongoose database access.
\item \textbf{Mongodb} is the database part of the application. It's a document oriented database where data is structured in JSON like documents.
\item \textbf{Angular.js} is a web application framework that provides client side model-view-controller(MVC). Angular.js is the front end part of the app.
